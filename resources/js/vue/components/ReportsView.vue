    ...
    <div>
        <div class="mb-6">
            ...
            <p class="text-muted-foreground">
                Inventory analytics and data export
            </p>
        </div>
            ...
            <div class="mb-6 grid grid-cols-4 gap-4">
                <div class="rounded-lg border bg-card p-4">
                    ...
                    <p class="text-2xl font-bold">
                        {{ summary?.totals?.total_products ?? 0 }}
                    </p>
                </div>
                <div class="rounded-lg border bg-card p-4">
                    <p class="text-sm text-muted-foreground">Inventory Value</p>
                    <p class="text-2xl font-bold">
                        ${{ formatNum(summary?.totals?.total_value ?? 0) }}
                    </p>
                </div>
                <div class="rounded-lg border bg-card p-4">
            ...
            <div class="mb-6 grid grid-cols-2 gap-6">
                <div class="rounded-lg border">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <tr
                                v-for="p in topProducts?.top_by_value"
                                :key="p.id"
                                class="border-b"
                            >
                ...
                <div class="rounded-lg border">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <tr
                                v-for="p in topProducts?.top_by_movement"
                                :key="p.id"
                                class="border-b"
                            >
                                <td class="px-4 py-2 font-medium">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-4 py-2 text-right">
                                    ${{ formatNum(cat.inventory_value) }}
                                </td>
                                <td class="px-4 py-2 text-right">
                                    ${{ formatNum(cat.inventory_cost) }}
                                </td>
                                <td class="px-4 py-2 text-right">
                                    <span
...
onMounted(async () => {
    const [summaryRes, topRes] = await Promise.all([
        ...
        axios.get<TopProductsReport>('/api/reports/top-products', {
            params: { limit: 5 },
        }),
    ]);
